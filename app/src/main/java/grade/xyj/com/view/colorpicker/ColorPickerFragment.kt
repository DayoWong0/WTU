package grade.xyj.com.view.colorpicker
...
import grade.xyj.com.component.course.setting.ColorPickViewModel
import grade.xyj.com.util.extend.getActivityViewModel
...
class ColorPickerFragment : BaseDialogFragment(), ColorPickerView.OnColorChangedListener, TextWatcher {
    ...
    lateinit var colorViewModel: ColorPickViewModel
    ...
    override fun onAttach(context: Context) {
        ...
        colorViewModel = getActivityViewModel()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_save.setOnClickListener {
            colorViewModel.result.value = Pair(dialogId,color)
            dismiss()
        }
